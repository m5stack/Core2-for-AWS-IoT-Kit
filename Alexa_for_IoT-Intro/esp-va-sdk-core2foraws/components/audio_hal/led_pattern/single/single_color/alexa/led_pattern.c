...
led_pattern_config_t led_lyrat_pattern_conf[LED_PATTERN_PATTERN_MAX];
...
void led_pattern_init(led_pattern_config_t **led_pattern_config)
{
    ...
    led_lyrat_pattern_conf[LED_PATTERN_WW_ACTIVE].led_states_count = sizeof(led_lyrat_ww_active) / sizeof(led_lyrat_ww_active[0]);
    led_lyrat_pattern_conf[LED_PATTERN_WW_ACTIVE].led_states = (led_pattern_state_t *)led_lyrat_ww_active;

    led_lyrat_pattern_conf[LED_PATTERN_WW_ONGOING].led_states_count = sizeof(led_lyrat_ww_ongoing) / sizeof(led_lyrat_ww_ongoing[0]);
    led_lyrat_pattern_conf[LED_PATTERN_WW_ONGOING].led_states = (led_pattern_state_t *)led_lyrat_ww_ongoing;

    led_lyrat_pattern_conf[LED_PATTERN_WW_DEACTIVATE].led_states_count = sizeof(led_lyrat_ww_deactive) / sizeof(led_lyrat_ww_deactive[0]);
    led_lyrat_pattern_conf[LED_PATTERN_WW_DEACTIVATE].led_states = (led_pattern_state_t *)led_lyrat_ww_deactive;
    ...
    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_END].led_states_count = sizeof(led_lyrat_mic_off_end) / sizeof(led_lyrat_mic_off_end[0]);
    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_END].led_states = (led_pattern_state_t *)led_lyrat_mic_off_end;

    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_ON].led_states_count = sizeof(led_lyrat_mic_off_on) / sizeof(led_lyrat_mic_off_on[0]);
    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_ON].led_states = (led_pattern_state_t *)led_lyrat_mic_off_on;

    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_START].led_states_count = sizeof(led_lyrat_mic_off_start) / sizeof(led_lyrat_mic_off_start[0]);
    led_lyrat_pattern_conf[LED_PATTERN_MIC_OFF_START].led_states = (led_pattern_state_t *)led_lyrat_mic_off_start;
    ...
    led_lyrat_pattern_conf[LED_PATTERN_BTCONNECT].led_states_count = sizeof(led_lyrat_btconnect) / sizeof(led_lyrat_btconnect[0]);
    led_lyrat_pattern_conf[LED_PATTERN_BTCONNECT].led_states = (led_pattern_state_t *)led_lyrat_btconnect;

    led_lyrat_pattern_conf[LED_PATTERN_BTDISCONNECT].led_states_count = sizeof(led_lyrat_btdisconnect) / sizeof(led_lyrat_btdisconnect[0]);
    led_lyrat_pattern_conf[LED_PATTERN_BTDISCONNECT].led_states = (led_pattern_state_t *)led_lyrat_btdisconnect;

    led_lyrat_pattern_conf[LED_PATTERN_NTF_QUEUED].led_states_count = sizeof(led_lyrat_ntf_queued) / sizeof(led_lyrat_ntf_queued[0]);
    led_lyrat_pattern_conf[LED_PATTERN_NTF_QUEUED].led_states = (led_pattern_state_t *)led_lyrat_ntf_queued;

    led_lyrat_pattern_conf[LED_PATTERN_NTF_INCOMING].led_states_count = sizeof(led_lyrat_ntf_incoming) / sizeof(led_lyrat_ntf_incoming[0]);
    led_lyrat_pattern_conf[LED_PATTERN_NTF_INCOMING].led_states = (led_pattern_state_t *)led_lyrat_ntf_incoming;
    ...
    led_lyrat_pattern_conf[LED_PATTERN_FACTORY_RESET].led_states_count = sizeof(led_lyrat_factory_rst) / sizeof(led_lyrat_factory_rst[0]);
    led_lyrat_pattern_conf[LED_PATTERN_FACTORY_RESET].led_states = (led_pattern_state_t *)led_lyrat_factory_rst;
