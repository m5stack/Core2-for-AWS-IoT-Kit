...
void SPI_INSTANCE_init(void)
{
	...
	spi_m_sync_init(&SPI_INSTANCE, SERCOM1);
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(RESET_PIN1, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(RESET_PIN1, GPIO_PIN_FUNCTION_OFF);
	
	
	gpio_set_pin_level(RESET_PIN2,
		// <y> Initial level
		// <id> pad_initial_level
		// <false"> Low
		// <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(RESET_PIN2, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(RESET_PIN2, GPIO_PIN_FUNCTION_OFF);
