...
/**
 * Get ESP Insights MQTT connection parameters
 *
 * @return MQTT connection parameters
 *
 */
esp_rmaker_mqtt_conn_params_t *esp_insights_mqtt_get_conn_params(void);
   
/** Initialize ESP Insights MQTT
 *
 ...
 */
esp_err_t esp_insights_mqtt_init(esp_rmaker_mqtt_conn_params_t *conn_params);
 ...
 * @return error in case of any error.
 */
esp_err_t esp_insights_mqtt_connect(void);
 ...
 * @return error in case of any error.
 */
esp_err_t esp_insights_mqtt_disconnect(void);
 ...
 * @param[out] msg_id Message ID of the publish message (for QoS 0 Message ID will always be zero) on success. -1 on failure.
 *
 * @return ESP_OK on success.
 * @return error in case of any error.
 */
 ...
 * @return error in case of any error.
 */
esp_err_t esp_insights_mqtt_unsubscribe(const char *topic);

/**
 * Setup MQTT callback functions for ESP Insights
 *
 * @param[in] mqtt_config MQTT configurations
 *
 * @return ESP_OK on success.
 * @return error in case of any error.
 */
